...
class Changer extends RPCResponse {
  ...
  @JsonKey(name: 'new_name', includeIfNull: false, fromJson: strToAccountName, toJson: accountNameToStr)
  AccountName newName;
  ...
  @JsonKey(name:'account_price', includeIfNull: false, toJson: currencyToDouble, fromJson: pascalToCurrency)
  ...
  factory Changer.fromJson(Map<String, dynamic> json) => _$ChangerFromJson(json);
