...
class AccountName {
  ...
  static String validate(String value) {
    ...
    if (value.length < 3) {
      throw Exception('Invalid account name, must be at least 3 characters long.');
    }
  ...
  String toStringEscaped() {
    return this.accountName.replaceAllMapped(RegExp(REGEX_TO_ESCAPE),(match) => '\\${match.group(0)}');
  }
