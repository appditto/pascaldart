...
void main() {
  group('Common.Util', () {
    ...
    test('test hex to binary and back', () {
      String hex = '67EDBC8F904091738DF33B4B6917261DB91DD9002D3985A7BA090345264A46C6';
      String binary = PDUtil.hexToBinary('67EDBC8F904091738DF33B4B6917261DB91DD9002D3985A7BA090345264A46C6');
      expect(PDUtil.binaryToHex(binary), hex);
    });
    test('can concat one or more byte arrays', () {
      final List<Uint8List> hexas = ['ABCD', '0020', 'FFFFFFDD'].map((hex) => PDUtil.hexToBytes(hex)).toList();
