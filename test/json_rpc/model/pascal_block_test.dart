...
void main() {
  group('json_rpc.model.pascal_block', () {
    test('can serialize block response', () {
      ...
      expect(PDUtil.byteToHex(PublicKeyCoder().encodeToBytes(block.encPubkey)), 'CA0220000E60B6F76778CFE8678E30369BA7B2C38D0EC93FC3F39E61468E29FEC39F13BF2000572EDE3C44CF00FF86AFF651474D53CCBDF86B953F1ECE5FB8FC7BB6FA16F114');
      ...
      expect(block.sbh, "5B75D33D9EFBF560EF5DA9B4A603528808626FE6C1FCEC44F83AF2330C6607EF");
      expect(block.oph, "81BE87831F03A2FE272C89BC6D2406DD57614846D9CEF30096BF574AB4AB3EE9");
      expect(block.pow, "00000000213A39EBBAB6D1FAEAA1EE528E398A587848F81FF66F7DA6113FC754");
