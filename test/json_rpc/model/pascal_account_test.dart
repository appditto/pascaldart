...
void main() {
  group('json_rpc.model.pascal_account', () {
    test('can serialize getaccount response', () {
      ...
      expect(PDUtil.byteToHex(PublicKeyCoder().encodeToBytes(getAcctResp.encPubkey)), 'CA0220009D92DFA1D6F8B2CAE31194EE5433EE4AD457AE145C1C67E49A9196EE58A45B9F200046EAF20C0A26A80A7693E71C0222313A0187AFCA838209FF86FB740A4FFF7F0B');
