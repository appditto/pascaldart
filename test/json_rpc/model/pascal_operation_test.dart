...
void main() {
  group('json_rpc.model.pascal_operation', () {
    test('can serialize operation response', () {
      ...
      expect(op.payload, "");
      expect(PDUtil.byteToHex(PublicKeyCoder().encodeToBytes(op.encPubkey)), 'CA02200078D867C93D58C2C46C66667A139543DCF8420D9119B7A0E06197D22A5BBCE5542000EA2E492FD8B90E48AF3D9EF438C6FBEA57C8A8E75889807DE588B490B1D57187');
      expect(op.ophash, '335400006C8D0100020000003330433034464446453130354434444445424141');
    });
  });
}
